...
nikolay             = User.create!(gender: "Homme", first_name: "Nikolay", last_name: "Martynov", email: "nikolai@gmail.com", password: '123456', status: "Etudiant", income: 5000, has_warrantor: true, warrantor_income: 4500, warrantor_type: "Famille", phone_number: "06.00.00.00.02")
...
alban               = User.create!(gender: "Homme", first_name: "Alban", last_name: "Porcheron", email: "alban@gmail.com", password: '123456', status: "Salarié", income: 5000, has_warrantor: true, warrantor_income: 6000, warrantor_type: "Famille", phone_number: "06.00.00.00.04")
url_alban           = 'https://avatars1.githubusercontent.com/u/25384564?v=3'
charles.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
alban.photo_url     = url_alban
mathieu             = User.create!(gender: "Homme", first_name: "Mathieu", last_name: "Cochet", email: "mathieu@gmail.com", password: '123456', status: "Indépendant", income: 3500, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.05")
...
achille             = User.create!(gender: "Homme", first_name: "Achille", last_name: "Miklitarian", email: "achille@gmail.com", password: '123456', status: "Salarié", income: 1500, has_warrantor: false, warrantor_income: 0, warrantor_type: "Famille", phone_number: "06.00.00.00.07")
url_achille         = 'https://avatars2.githubusercontent.com/u/25741493?v=3'
achille.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
...
patrick             = User.create!(gender: "Homme", first_name: "Patrick", last_name: "Berczelly", email: "patrick@gmail.com", password: '123456', status: "Autre", income: 4500, has_warrantor: false, warrantor_income: 0, warrantor_type: "Aucun", phone_number: "06.00.00.00.13")
...
alex                = User.create!(gender: "Homme", first_name: "Alex", last_name: "Deniau", email: "alex@gmail.com", password: '123456', status: "Indépendant", income: 2000, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.15")
url_alex            = 'https://avatars2.githubusercontent.com/u/25634191?v=3'
charles.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
alex.photo_url      = url_alex
alexandre           = User.create!(gender: "Homme", first_name: "Alexandre", last_name: "Grenier", email: "alexandre@gmail.com", password: '123456', status: "Indépendant", income: 2000, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.16")
url_alexandre       = 'https://avatars0.githubusercontent.com/u/26217119?v=3'
charles.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
alexandre.photo_url = url_alexandre
arnaud              = User.create!(gender: "Homme", first_name: "Arnaud", last_name: "Boscq", email: "arnaud@gmail.com", password: '123456', status: "Indépendant", income: 6000, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.17")
url_arnaud          = 'https://avatars3.githubusercontent.com/u/26063436?v=3'
charles.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
arnaud.photo_url    = url_arnaud
aurore              = User.create!(gender: "Femme", first_name: "Aurore", last_name: "Courtois", email: "aurore@gmail.com", password: '123456', status: "Indépendant", income: 5000, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.20")
...
benoit              = User.create!(gender: "Homme", first_name: "Benoit", last_name: "Paternot", email: "benoit@gmail.com", password: '123456', status: "Indépendant", income: 4000, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.22")
url_benoit          = 'https://avatars2.githubusercontent.com/u/25432253?v=3'
charles.description = 'Qui n’a jamais pensé à écrire sa biographie, son autobiographie ?! A vrai dire, je penses pouvoir dire que chaque personne pense au moins une fois dans sa vie à écrire ses mémoires, réciter les évènements qui ont marqué leurs années d’existence. Pourquoi ? Tout simplement pour ne pas avoir vécu sans laisser de traces. Une biographie est en effet le moyen le plus efficace pour parler de soi et qui sait faire parler de soi aussi.'
benoit.photo_url    = url_benoit
bruno               = User.create!(gender: "Homme", first_name: "Bruno", last_name: "Lajoie", email: "bruno@gmail.com", password: '123456', status: "Indépendant", income: 4500, has_warrantor: true, warrantor_income: 2000, warrantor_type: "Famille", phone_number: "06.00.00.00.23")
...
s_16 = Search.create!(size_min: 60, rent_max: 1800, address: "68 Rue Oberkampf, 75020 PARIS", tenant: benjamin)
s_17 = Search.create!(size_min: 60, rent_max: 1800, address: "68 Rue Oberkampf, 75020 PARIS", tenant: benoit)
s_18 = Search.create!(size_min: 60, rent_max: 1800, address: "68 Rue Oberkampf, 75020 PARIS", tenant: bruno)
s_19 = Search.create!(size_min: 60, rent_max: 2100, address: "68 Rue Oberkampf, 75020 PARIS", tenant: mathieu)
s_20 = Search.create!(size_min: 65, rent_max: 2100, address: "68 Rue Oberkampf, 75020 PARIS", tenant: mathieu)
s_21 = Search.create!(size_min: 65, rent_max: 2100, address: "68 Rue Oberkampf, 75020 PARIS", tenant: xavier)
s_22 = Search.create!(size_min: 65, rent_max: 2200, address: "68 Rue Oberkampf, 75020 PARIS", tenant: nikolay)
